...
#define CS_LOW GPIOA->ODR &= ~CS_Pin
#define CS_HIGH GPIOA->ODR |= CS_Pin

#define RESET_LOW GPIOA->ODR &=~RESET_Pin  //SET RESET LOW
#define RESET_HIGH GPIOA->ODR |=RESET_Pin  //SET RESET HIGH

//#define A0_LOW  HAL_GPIO_WritePin(DC_GPIO_Port, DC_Pin, GPIO_PIN_RESET)
//#define A0_HIGH HAL_GPIO_WritePin(DC_GPIO_Port, DC_Pin, GPIO_PIN_SET)

#define A0_LOW  GPIOA->ODR &= ~A0_Pin
#define A0_HIGH GPIOA->ODR |= A0_Pin
